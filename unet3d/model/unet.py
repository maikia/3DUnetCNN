...
def unet_model_3d(input_shape, pool_size=(2, 2, 2), n_labels=1,
    ...
    :param include_label_wise_dice_coefficients: If True and n_labels is
        ...
        as metric.
    :param n_base_filters: The number of filters that the first layer in the
    ...
    :param depth: indicates the depth of the U-shape for the model. The greater
        the depth, the more max pooling layers will be added to the model.
        Lowering the depth may reduce the amount of memory required for
        training.
    :param input_shape: Shape of the input data
        (n_chanels, x_size, y_size, z_size). The x, y, and z sizes must be
        divisible by the pool size to the power of the depth of the UNet, that
        is pool_size^depth.
    ...
    :param deconvolution: If set to True, will use transpose
        ...
        amount memory required during training.
